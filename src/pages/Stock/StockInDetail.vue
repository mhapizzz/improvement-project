<template>
  <div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg p-6 text-white">
      <h2 class="text-2xl font-bold mb-2">Stock IN</h2>
      <p class="text-green-100">Manage incoming inventory items</p>
    </div>

    <!-- Information Card -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h3 class="text-lg font-semibold text-gray-900 mb-4">Purchase Order Information</h3>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="space-y-3">
          <div class="flex justify-between items-center">
            <span class="text-sm font-medium text-gray-600">PO Number:</span>
            <span class="text-sm font-semibold text-gray-900">1100086756</span>
          </div>
          <div class="flex justify-between items-center">
            <span class="text-sm font-medium text-gray-600">SPB Number:</span>
            <span class="text-sm font-semibold text-gray-900">025/DO/HRS-AGM/VI/2025</span>
          </div>
          <div class="flex justify-between items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      <div class="px-6 py-4 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-600 mt-1">{{ stockItems.length }} items in this order</p>
      </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-sm text-gray-600">Ready to process</p>
        </div>
      ...
      <div class="mt-6 flex flex-wrap gap-3">
        <button class="flex-1 bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors duration-200 font-medium">
          Process Stock In
        </button>
